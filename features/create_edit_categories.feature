Feature: Create Categories
  ...
  Scenario: Successfully create and edit categories
    ...
    When I fill in "category_name" with "Foobar new"
    And I fill in "category_keywords" with "Lorem Ipsum1"
    And I fill in "category_permalink" with "GG2"
    And I fill in "category_description" with "desc3"
    And I press "Save"
    Then I should see "Foobar new"
    Then I should see "Lorem Ipsum1"
    Then I should see "GG2"
    Then I should see "desc3"
